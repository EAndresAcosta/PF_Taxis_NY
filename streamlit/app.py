...
if st.button("💡 ¡Calcular Mi Viaje!"):
    ...
    if direccion_origen == "" or direccion_destino == "":
        ...
        if np.isnan(tiempo) or np.isnan(distancia):
            ...
            st.write("🗺️ **El mapa proporciona datos sobre la calidad del aire en distintas zonas de la ciudad: marcador color 🟦**: calidad del aire buena, **marcador color 🟨**: calidad del aire moderada, **marcador color 🟥**: calidad del aire mala.")
